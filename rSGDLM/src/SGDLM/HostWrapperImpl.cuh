...
template <typename DOUBLE> class HostWrapperImpl : public HostWrapper<DOUBLE> {
public:
  ...
  void initMemory(
      std::size_t m,
      std::size_t
          max_p); //, const DOUBLE* host_data_m_t, const DOUBLE* host_data_C_t,
                  // const DOUBLE* host_data_n_t, const DOUBLE* host_data_s_t,
                  // const DOUBLE* host_data_beta, const DOUBLE*
                  // host_data_delta, const unsigned int* host_data_p, const
                  // unsigned int* host_data_sp_indices);
  ...
  void getParameters(DOUBLE *host_data_m_t, DOUBLE *host_data_C_t,
                     DOUBLE *host_data_n_t, DOUBLE *host_data_s_t) const;

  void setParameters(const DOUBLE *host_data_m_t, const DOUBLE *host_data_C_t,
                     const DOUBLE *host_data_n_t, const DOUBLE *host_data_s_t);

  void getDiscountFactors(DOUBLE *host_data_beta,
                          DOUBLE *host_data_delta) const;

  void setDiscountFactors(const DOUBLE *host_data_beta,
  ...
  void getParentalSets(unsigned int *host_data_p,
                       unsigned int *host_data_sp_indices) const;

  void setParentalSets(const unsigned int *host_data_p,
  ...
  void evolveForecastSamples();

  void evolveForecastSamples(const DOUBLE *host_data_G_tp1);
