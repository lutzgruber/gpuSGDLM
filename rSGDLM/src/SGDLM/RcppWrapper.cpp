...
SGDLM::RcppWrapper<DOUBLE>::RcppWrapper()
    : wrapper(SGDLM::HostWrapperFactory<DOUBLE>::create(1)) {
  DEBUG_LOGGER << "RcppWrapper::RcppWrapper()" << ENDL;
}

template <typename DOUBLE>
SGDLM::RcppWrapper<DOUBLE>::RcppWrapper(std::size_t no_gpus)
...
template <typename DOUBLE>
void SGDLM::RcppWrapper<DOUBLE>::clearGPUAllMemory() {
...
template <typename DOUBLE>
void SGDLM::RcppWrapper<DOUBLE>::clearGPUSimMemory() {
...
template <typename DOUBLE>
Rcpp::List SGDLM::RcppWrapper<DOUBLE>::getSimultaneousParents() const {
  ...
  unsigned int *data_sp =
      host_MEM_temp.host_alloc_vec<unsigned int>(no_elements);

  wrapper->getParentalSets(data_p, data_sp);

  std::vector<unsigned int> p =
      memory_manager_RCPP::getSTDVector<unsigned int>(data_p, m);
  Rcpp::IntegerVector sp =
      memory_manager_RCPP::getRcppVector<unsigned int, Rcpp::IntegerVector>(
          data_sp, 2, dim);
...
template <typename DOUBLE>
void SGDLM::RcppWrapper<DOUBLE>::setSimultaneousParents(
    const std::vector<unsigned int> &p, const Rcpp::IntegerVector &sp) {
  ...
  unsigned int *data_p =
      host_MEM_temp.getData<unsigned int, std::vector<unsigned int>>(p);
  unsigned int *data_sp =
      host_MEM_temp.getData<unsigned int, Rcpp::IntegerVector>(sp);
...
template <typename DOUBLE>
Rcpp::List SGDLM::RcppWrapper<DOUBLE>::getDiscountFactors() const {
...
template <typename DOUBLE>
Rcpp::List SGDLM::RcppWrapper<DOUBLE>::getParameters() const {
  DEBUG_LOGGER << "RcppWrapper::getParameters()" << ENDL;

  memory_manager_RCPP host_MEM_temp;

  DOUBLE *data_m_t = host_MEM_temp.host_alloc_vec<DOUBLE>(
      wrapper->getNoSeries() * wrapper->getMaxP());
  DOUBLE *data_C_t = host_MEM_temp.host_alloc_vec<DOUBLE>(
      wrapper->getNoSeries() * wrapper->getMaxP() * wrapper->getMaxP());
  DOUBLE *data_n_t =
      host_MEM_temp.host_alloc_vec<DOUBLE>(wrapper->getNoSeries());
  DOUBLE *data_s_t =
      host_MEM_temp.host_alloc_vec<DOUBLE>(wrapper->getNoSeries());
  ...
  std::size_t dim_C_t[] = {wrapper->getMaxP(), wrapper->getMaxP(),
                           wrapper->getNoSeries()};

  Rcpp::NumericVector m_t =
      memory_manager_RCPP::getRcppVector<DOUBLE, Rcpp::NumericVector>(
          data_m_t, 2, dim_m_t);
  Rcpp::NumericVector C_t =
      memory_manager_RCPP::getRcppVector<DOUBLE, Rcpp::NumericVector>(
          data_C_t, 3, dim_C_t);
  std::vector<DOUBLE> n_t = memory_manager_RCPP::getSTDVector<DOUBLE>(
      data_n_t, wrapper->getNoSeries());
  std::vector<DOUBLE> s_t = memory_manager_RCPP::getSTDVector<DOUBLE>(
      data_s_t, wrapper->getNoSeries());

  return Rcpp::List::create(Rcpp::Named("m") = m_t, Rcpp::Named("C") = C_t,
                            Rcpp::Named("n") = n_t, Rcpp::Named("s") = s_t);
}

template <typename DOUBLE>
void SGDLM::RcppWrapper<DOUBLE>::setPriorParameters(
    const Rcpp::NumericVector &m_t, const Rcpp::NumericVector &C_t,
    const std::vector<DOUBLE> &n_t, const std::vector<DOUBLE> &s_t) {
...
template <typename DOUBLE>
void SGDLM::RcppWrapper<DOUBLE>::setPosteriorParameters(
    const Rcpp::NumericVector &m_t, const Rcpp::NumericVector &C_t,
    const std::vector<DOUBLE> &n_t, const std::vector<DOUBLE> &s_t) {
...
template <typename DOUBLE>
void SGDLM::RcppWrapper<DOUBLE>::setParameters(const Rcpp::NumericVector &m_t,
  ...
  if (m_arg_1 != wrapper->getNoSeries() || m_arg_2 != wrapper->getNoSeries() ||
      m_arg_3 != wrapper->getNoSeries() || m_arg_4 != wrapper->getNoSeries() ||
      max_p_arg_1 != wrapper->getMaxP() ||
      max_p_arg_2_1 != wrapper->getMaxP() ||
      max_p_arg_2_2 != wrapper->getMaxP()) {
    ERROR_LOGGER << "Dimensions of input arguments are incompatible" << ENDL;
    return;
  }
...
template <typename DOUBLE>
void SGDLM::RcppWrapper<DOUBLE>::computePosterior(
    const std::vector<DOUBLE> &y_t, const Rcpp::NumericVector &F_t) {
...
template <typename DOUBLE>
Rcpp::List
SGDLM::RcppWrapper<DOUBLE>::computeVBPosterior(std::size_t nsim,
                                               std::size_t nsim_batch) {
  DEBUG_LOGGER << "RcppWrapper::computeVBPosterior()" << ENDL;

  if (nsim != wrapper->getNSim() ||
      nsim_batch != wrapper->getNSimBatch()) { // initialize simulation memory
  ...
  DOUBLE *data_mean_m_t = host_MEM_temp.host_alloc_vec<DOUBLE>(
      wrapper->getNoSeries() * wrapper->getMaxP());
  DOUBLE *data_mean_C_t = host_MEM_temp.host_alloc_vec<DOUBLE>(
      wrapper->getNoSeries() * wrapper->getMaxP() * wrapper->getMaxP());
  DOUBLE *data_mean_n_t =
      host_MEM_temp.host_alloc_vec<DOUBLE>(wrapper->getNoSeries());
  DOUBLE *data_mean_s_t =
      host_MEM_temp.host_alloc_vec<DOUBLE>(wrapper->getNoSeries());
  DOUBLE *data_IS_weights =
      host_MEM_temp.host_alloc_vec<DOUBLE>(wrapper->getNSim());
  DOUBLE sum_det_weights = 0;

  // compute VB posterior on GPU
  wrapper->computeVBPosterior(data_mean_m_t, data_mean_C_t, data_mean_n_t,
                              data_mean_s_t, data_IS_weights, &sum_det_weights);
  ...
  Rcpp::NumericVector m_t =
      memory_manager_RCPP::getRcppVector<DOUBLE, Rcpp::NumericVector>(
          data_mean_m_t, 2, dim_m_t);
  Rcpp::NumericVector C_t =
      memory_manager_RCPP::getRcppVector<DOUBLE, Rcpp::NumericVector>(
          data_mean_C_t, 3, dim_C_t);
  std::vector<DOUBLE> n_t = memory_manager_RCPP::getSTDVector<DOUBLE>(
      data_mean_n_t, wrapper->getNoSeries());
  std::vector<DOUBLE> s_t = memory_manager_RCPP::getSTDVector<DOUBLE>(
      data_mean_s_t, wrapper->getNoSeries());
  std::vector<DOUBLE> IS_weights = memory_manager_RCPP::getSTDVector<DOUBLE>(
      data_IS_weights, wrapper->getNSim());

  return Rcpp::List::create(Rcpp::Named("m") = m_t, Rcpp::Named("C") = C_t,
                            Rcpp::Named("n") = n_t, Rcpp::Named("s") = s_t,
                            Rcpp::Named("IS_weights") = IS_weights,
                            Rcpp::Named("sum_det_weights") = sum_det_weights);
}
...
template <typename DOUBLE>
void SGDLM::RcppWrapper<DOUBLE>::computeEvoPrior(
  ...
  if (m_arg_1 != wrapper->getNoSeries() ||
      max_p_arg_1_1 != wrapper->getMaxP() ||
  ...
  DOUBLE *data_G_tp1 =
      host_MEM_temp.getData<DOUBLE, Rcpp::NumericVector>(G_tp1);
...
template <typename DOUBLE>
Rcpp::NumericVector
SGDLM::RcppWrapper<DOUBLE>::computeForecast(std::size_t nsim,
                                            std::size_t nsim_batch,
  ...
  DOUBLE *data_y_tp1 = host_MEM_temp.host_alloc_vec<DOUBLE>(
      wrapper->getNSim() * wrapper->getNoSeries() * nsteps_arg_3);
  DOUBLE *data_F_tp1 =
      host_MEM_temp.getData<DOUBLE, Rcpp::NumericVector>(F_tp1);
  ...
  for (std::size_t k = 0; k < nsteps_arg_3; k++) {
    ...
    DOUBLE *data_y_tp1_pointer_pos =
        (DOUBLE *)((char *)data_y_tp1 + k * wrapper->getNoSeries() *
                                            wrapper->getNSim() *
                                            sizeof(DOUBLE));
    DOUBLE *data_F_tp1_pointer_pos =
        (DOUBLE *)((char *)data_F_tp1 + k * wrapper->getNoSeries() *
                                            wrapper->getMaxP() *
                                            sizeof(DOUBLE));
    wrapper->computeForecast(data_y_tp1_pointer_pos, data_F_tp1_pointer_pos,
                             NULL, NULL, (k > 0));
  }

  Rcpp::NumericVector y_tp1 =
      memory_manager_RCPP::getRcppVector<DOUBLE, Rcpp::NumericVector>(
          data_y_tp1, dim_arg_3.size(), dim_y_tp1);

  return y_tp1;
}

template <typename DOUBLE>
Rcpp::List SGDLM::RcppWrapper<DOUBLE>::computeForecastDebug(
    std::size_t nsim, std::size_t nsim_batch,
    const Rcpp::NumericVector &F_tp1) {
  DEBUG_LOGGER << "RcppWrapper::computeForecastDebug()" << ENDL;
  ...
  DOUBLE *data_y_tp1 = host_MEM_temp.host_alloc_vec<DOUBLE>(
      wrapper->getNSim() * wrapper->getNoSeries() * nsteps_arg_3);
  DOUBLE *data_lambdas = host_MEM_temp.host_alloc_vec<DOUBLE>(
      wrapper->getNSim() * wrapper->getNoSeries() * nsteps_arg_3);
  DOUBLE *data_thetas = host_MEM_temp.host_alloc_vec<DOUBLE>(
      wrapper->getNSim() * wrapper->getNoSeries() * wrapper->getMaxP() *
      nsteps_arg_3);
  DOUBLE *data_F_tp1 =
      host_MEM_temp.getData<DOUBLE, Rcpp::NumericVector>(F_tp1);
  ...
  for (std::size_t k = 0; k < nsteps_arg_3; k++) {
    ...
    DOUBLE *data_y_tp1_pointer_pos =
        (DOUBLE *)((char *)data_y_tp1 + k * wrapper->getNoSeries() *
                                            wrapper->getNSim() *
                                            sizeof(DOUBLE));
    DOUBLE *data_lambdas_pointer_pos =
        (DOUBLE *)((char *)data_lambdas + k * wrapper->getNoSeries() *
                                              wrapper->getNSim() *
                                              sizeof(DOUBLE));
    DOUBLE *data_thetas_pointer_pos =
        (DOUBLE *)((char *)data_thetas +
                   k * wrapper->getNoSeries() * wrapper->getMaxP() *
                       wrapper->getNSim() * sizeof(DOUBLE));
    DOUBLE *data_F_tp1_pointer_pos =
        (DOUBLE *)((char *)data_F_tp1 + k * wrapper->getNoSeries() *
                                            wrapper->getMaxP() *
                                            sizeof(DOUBLE));
    wrapper->computeForecast(data_y_tp1_pointer_pos, data_F_tp1_pointer_pos,
                             data_lambdas_pointer_pos, data_thetas_pointer_pos,
                             (k > 0));
  }
  ...
  Rcpp::NumericVector lambdas =
      memory_manager_RCPP::getRcppVector<DOUBLE, Rcpp::NumericVector>(
          data_lambdas, dim_arg_3.size(), dim_y_tp1);

  std::size_t dim_thetas[] = {wrapper->getMaxP(), wrapper->getNoSeries(),
                              wrapper->getNSim(), nsteps_arg_3};
  Rcpp::NumericVector thetas =
      memory_manager_RCPP::getRcppVector<DOUBLE, Rcpp::NumericVector>(
          data_thetas, dim_arg_3.size() + 1, dim_thetas);

  return Rcpp::List::create(Rcpp::Named("y") = y_tp1,
                            Rcpp::Named("lambdas") = lambdas,
                            Rcpp::Named("thetas") = thetas);
}

template <typename DOUBLE>
Rcpp::NumericVector SGDLM::RcppWrapper<DOUBLE>::computeEvoForecast(
    std::size_t nsim, std::size_t nsim_batch, const Rcpp::NumericVector &F_tp1,
    const Rcpp::NumericVector &G_tp1) {
  ...
  if (dim_G_tp1.size() == 4) {
    ...
    if (nsteps_arg_1 > 1) {
      if (nsteps_arg_1 != nsteps_arg_3) {
        ERROR_LOGGER << "Dimensions of input arguments are incompatible"
                     << ENDL;
        return Rcpp::NumericVector();
        ;
      }
  ...
  for (std::size_t k = 0; k < nsteps_arg_3; k++) {
    if (k > 0) {
      const DOUBLE *data_G_tp1_pointer_pos =
          (const DOUBLE *)((char *)data_G_tp1 +
...
template <typename DOUBLE>
Rcpp::List SGDLM::RcppWrapper<DOUBLE>::computeEvoForecastDebug(
    std::size_t nsim, std::size_t nsim_batch, const Rcpp::NumericVector &F_tp1,
    const Rcpp::NumericVector &G_tp1) {
  DEBUG_LOGGER << "RcppWrapper::computeEvoForecastDebug()" << ENDL;
...
template <typename DOUBLE>
std::size_t SGDLM::RcppWrapper<DOUBLE>::getLogLevel() const {
...
template <typename DOUBLE>
void SGDLM::RcppWrapper<DOUBLE>::setLogLevel(std::size_t loglevel) {
