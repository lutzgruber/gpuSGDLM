...
SGDLM::HostWrapper<DOUBLE> *
SGDLM::HostWrapperFactory<DOUBLE>::create(std::size_t no_gpus) {
...
template <typename DOUBLE>
SGDLM::HostWrapper<DOUBLE> *
SGDLM::HostWrapperFactory<DOUBLE>::create(std::size_t no_gpus, std::size_t m,
                                          std::size_t max_p) {
  SGDLM::HostWrapper<DOUBLE> *wrapper = new HostWrapperImpl<DOUBLE>(no_gpus);
